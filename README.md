...
**Done:** workspace scaffold, shared support-email task, Langfuse wiring, from-scratch core loop (1–9, 11–13) ported to LangChain and MAF, MCP server + tool-use client.

**Next:** Knowledge retrieval / RAG (#14) from scratch.
