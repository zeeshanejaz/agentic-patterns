...
id: opsx-verify
category: Workflow
description: Review code changes against an OpenSpec spec and report whether implementation matches
---
...
**Input**: Optionally specify a change name after `/opsx:verify` (e.g., `/opsx:verify add-auth`). If omitted, infer from conversation context. If vague or ambiguous you MUST prompt for available changes.
